...
@Component
@Provides
@Instantiate(name = "OW2 JOnAS Configuration Admin Uninstall Processor")
public class ConfigurationsUninstallDelegateInternalProcessor extends DelegateHandlerProcessor<ConfigAdmin> {

    public ConfigurationsUninstallDelegateInternalProcessor() throws ProcessorException {
        super(new ConfigurationsUninstallProcessor(), ConfigAdmin.class);
    }
